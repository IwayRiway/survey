                      ...
                      <td style="vertical-align:top;padding:0px;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                          <tbody>
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Poppins, Lato, Helvetica, Arial, sans-serif;font-size:18.5px;line-height:1.5;text-align:center;color:#000000;"><strong>Laporan Hasil Survey Lapangan</strong>
                                  <br>
                                </div>
                              </td>
                            </tr>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                <div style="font-family:Poppins, Lato, Helvetica, Arial, sans-serif;font-size:16px;line-height:1.5;text-align:left;color:#000000;"><br>Yth. Direksi <br><br> Store dibawah ini telah selesai disurvei, berikut hasil laporan survey lapangan : </div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <td style="vertical-align:top;padding:0px;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                <div style="font-family:Poppins, Lato, Helvetica, Arial, sans-serif;font-size:16px;font-weight:100;line-height:1.5;text-align:left;color:#000000;"><br><strong>Nama Toko<span>: <?=$nama?></span></strong></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                <div style="font-family:Poppins, Lato, Helvetica, Arial, sans-serif;font-size:16px;font-weight:100;line-height:1.5;text-align:left;color:#000000;"><strong>Region <span>: <?=$region?></span></strong></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                <div style="font-family:Poppins, Lato, Helvetica, Arial, sans-serif;font-size:16px;font-weight:100;line-height:1.5;text-align:left;color:#000000;"><strong>Manager <span>: <?=$manager?></span></strong></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:0px;padding-top:20px;word-break:break-word;">
                                <div style="font-family:Poppins, Lato, Helvetica, Arial, sans-serif;font-size:16px;line-height:1.5;text-align:left;color:#000000;">Untuk detail laporan dapat anda unduh pada lampiran dibawah ini. Terima Kasih~</div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
